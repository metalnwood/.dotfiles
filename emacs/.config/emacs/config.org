...
#+begin_src emacs-lisp
  ...
  (setq display-line-numbers-type t)
     ...
     ;; Set search so that i-search will finish at the start of the search term, not the end.
    
     (defun my-goto-match-beginning ()
       (when (and isearch-forward isearch-other-end (not isearch-mode-end-hook-quit))
         (goto-char isearch-other-end)))
     (define-key isearch-mode-map (kbd "C-v") 'isearch-exit)
...
#+begin_src emacs-lisp
  ...
  ;        :global-prefix "M-SPC")
  	...
  	"qq" '(save-buffers-kill-terminal :wk "Close Emacs")
  	"'" '(jump-to-register :wk "Jump to Register")
  	"m" '(point-to-register :wk "Save Point to Register")  	
          ))
...
;good keys to rebind C-q C-j C-m 
  (global-set-key  (kbd  "C-z")  #'jason-center)
    ;  (global-set-key  (kbd "M-RET")    #'er/expand-region)
      ...
      (global-set-key  (kbd "C-M-S-n")  #'next-buffer)
      (global-set-key  (kbd "C-M-S-h")  #'previous-buffer)
